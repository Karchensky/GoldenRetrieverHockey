 ...
 * quote costs for the eight drafts and nothing can quote them for a provider
...
async function showBlueprint(blueprintId: number): Promise<number> {
  ...
  console.log(`the per-provider price sits on that screen. docs/STORE.md walks it.`);
  return 0;
}
