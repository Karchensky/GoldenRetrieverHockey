 ...
 *   13449786  Plumpables             (etsy)                ← a different business
 *
 * The second one is a live Etsy storefront that has nothing to do with a beer
...
export const FORBIDDEN_SHOPS: ReadonlyMap<number, string> = new Map([
  [13449786, "Plumpables — a live Etsy storefront for an unrelated business"],
]);
